    ...
    <>
      ...
      <aside className="flex">
        <div className="flex flex-col items-center w-16 h-screen py-8 space-y-8 bg-white dark:bg-gray-900 dark:border-blue-700">
          ...
          <Link href="#" className="p-1.5 text-blue-500 focus:outline-nones transition-colors duration-200 rounded-lg dark:text-blue-400 dark:hover:bg-blue-800 hover:bg-blue-100">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
